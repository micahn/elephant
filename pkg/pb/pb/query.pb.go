...
const file_query_proto_rawDesc = "" +
	...
	"maxresults\x12 \n" +
	"\vexactsearch\x18\x04 \x01(\bR\vexactsearch\"\xaa\x04\n" +
	"\rQueryResponse\x12\x10\n" +
	"\x03qid\x18\x01 \x01(\x05R\x03qid\x12\x10\n" +
	"\x03iid\x18\x02 \x01(\x05R\x03iid\x12*\n" +
	"\x04item\x18\x03 \x01(\v2\x16.pb.QueryResponse.ItemR\x04item\x1a\xa9\x03\n" +
	"\x04Item\x12\x1e\n" +
	"\n" +
	...
	"\x05state\x18\v \x03(\tR\x05state\x1aU\n" +
	"\tFuzzyInfo\x12\x14\n" +
